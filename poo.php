...
$queryprd = "SELECT * FROM `product` ORDER BY p_id DESC" or dis("Error:".mysqli_error());
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col col-sm-12 col-md-12">
          <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #ff7878;">
          ...
          <div class="row">
            <div class="col-6 col-sm-3 col-md-3" style="margin-bottom: 20px;">
              <div class="card" style="width: 100%;">
                <img src="img/888.jpg" <?php echo $rsprd['p_pic']; ?> class="card-img-top" alt="...">
                <div class="card-body">
